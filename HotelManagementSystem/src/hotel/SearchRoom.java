...
public class SearchRoom extends JFrame {
    ...
    public SearchRoom() throws SQLException{
        ...
        lblPrice_1.setBounds(485,162,46,14);
        ...
        JCheckBox checkRoom=new JCheckBox("OnlyDisplay Available");
       ...
       btnSearch.addActionListener(new ActionListener(){
           public void actionPerformed(ActionEvent e){
               ...
               String SQL2="select * from Room where avalability ='Available' AND bed_type ='"+c1.getSelectedItem()+"'";
